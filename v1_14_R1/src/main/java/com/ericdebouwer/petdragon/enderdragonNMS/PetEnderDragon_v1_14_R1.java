...
public class PetEnderDragon_v1_14_R1 extends EntityEnderDragon  implements PetEnderDragon {
		...
		try {
			if (!IRegistry.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
				...
				Map<String, Type<?>> types = (Map<String, Type<?>>) DataConverterRegistry.a().getSchema(
						DataFixUtils.makeKey(SharedConstants.a().getWorldVersion()))
				...
				IRegistry.a(IRegistry.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
						EntityTypes.a.a(PetEnderDragon_v1_14_R1::new, EnumCreatureType.MONSTER).a().a(PetEnderDragon.ENTITY_ID));
			}
	...
	public PetEnderDragon_v1_14_R1(org.bukkit.World world){
