...
public class PetEnderDragon_v1_16_R2 extends EntityEnderDragon  implements PetEnderDragon {
		...
		try {
			if (!IRegistry.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
				...
				IRegistry.a(IRegistry.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
						EntityTypes.Builder.a(PetEnderDragon_v1_16_R2::new, EnumCreatureType.MONSTER).a().a(PetEnderDragon.ENTITY_ID));
			}
	...
	public PetEnderDragon_v1_16_R2(org.bukkit.World world) {
